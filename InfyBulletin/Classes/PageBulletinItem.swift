...
open class PageBulletinItem: ListItem{
    ...
    ///An TitleLableTextColor
    public var titleColor: UIColor?
    public var tableLableColor: UIColor = UIColor.black
    public var tableBackButtonColor: UIColor = UIColor.clear
...
//    public var items = [String]()
    ...
    public var manager: ListManager?
    ...
    public var nextItem: ListItem? = nil
    
    public var globalInset = 10.0
    // MARK: - Customization
    ...
    fileprivate var actionButton: ListContainerView<HighlightButton>? = nil
   ...
   public func makeArrangedSubviews() -> [UIView] {
        ...
        if let alternativeButtonTitle = self.alternativeButtonTitle {
            ...
            arrangedSubviews.append(alternativeButton)
