...
//        
//        hideActivityIndicator().startAnimating()
//        
//        let animations = {
//            self.hideActivityIndicator.alpha = 1
//            self.contentStackView.alpha = 0
//        }
//        
//        UIView.animate(withDuration: 0.25, animations: animations) { _ in
//            UIAccessibilityPostNotification(UIAccessibilityScreenChangedNotification, self.hideActivityIndicator)
//        }
//        
//    }
//    
//    func hideActivityIndicator() {
//        hideActivityIndicator.stopAnimating()
//        hideActivityIndicator.alpha = 0
//    }
    ...
    //private let activityIndicator = hideActivityIndicator()
...
//        hideActivityIndicator.translatesAutoresizingMaskIntoConstraints = false
//        
//        view.addSubview(hideActivityIndicatorhideActivityIndicator)
//        hideActivityIndicatorhideActivityIndicator.leftAnchor.constraint(equalTo: contentStackView.leftAnchor).isActive = true
//        hideActivityIndicatorhideActivityIndicator.rightAnchor.constraint(equalTo: contentStackView.rightAnchor).isActive = true
//        hideActivityIndicatorhideActivityIndicator.topAnchor.constraint(equalTo: contentStackView.topAnchor).isActive = true
//        hideActivityIndicator.bottomAnchor.constraint(equalTo: contentStackView.bottomAnchor).isActive = true
//        
//        hideActivityIndicator.activityIndicatorViewStyle = .whiteLarge
//        hideActivityIndicator.color = .black
//        hideActivityIndicator.isUserInteractionEnabled = true
//        
//        hideActivityIndicator.alpha = 0
